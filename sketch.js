...
var knife,fruit ,monster,fruitGroup,monsterGroup,randomFruit, position,score,scoreText;
...
function preload(){
  ...
  //load sound here
  knifeSwoosh=loadSound("knife slash.mp3");
  gameOverSound=loadSound("GameOver sound effect.mp3");
}
...
function draw() {
  ...
  //Display score
  textSize(25);
 scoreText= text("Score : "+ score,250,50);
}
